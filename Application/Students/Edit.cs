    ...
    public class Edit
    {
        ...
        public class Handler : IRequestHandler<Command, Student>
        {
            ...
            public async Task<Student> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                student.Registration_number = request.Registration_number ?? student.Registration_number;
                student.Student_marks = request.Student_marks ?? student.Student_marks;
                student.Batch = request.Batch ?? student.Batch;
